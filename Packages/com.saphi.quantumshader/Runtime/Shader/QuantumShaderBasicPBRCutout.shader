...
inline float2 POM( sampler2D heightMap, float2 uvs, float2 dx, float2 dy, float3 normalWorld, float3 viewWorld, float3 viewDirTan, int minSamples, int maxSamples, int sidewallSteps, float parallax, float refPlane, float2 tilling, float2 curv, int index )
{
	...
	return uvs.xy + finalTexOffset;
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float2 MainUV261 = uv_MainTex;
			float2 temp_output_1_0_g253 = MainUV261;
			...
			#endif
			float2 MainUVFinal262 = staticSwitch10_g253;
			float2 uv_DetailNormalMap = i.uv_texcoord * _DetailNormalMap_ST.xy + _DetailNormalMap_ST.zw;
			float3 Normal64 = BlendNormals( UnpackScaleNormal( tex2D( _BumpMap, MainUVFinal262 ), _BumpScale ) , UnpackScaleNormal( tex2D( _DetailNormalMap, uv_DetailNormalMap ), _DetailNormalMapScale ) );
			o.Normal = Normal64;
			...
			float2 temp_output_286_0_g254 = MainUVFinal262;
			...
			float RoghnessValue84 = tex2D( _RoughnessMap, MainUVFinal262 ).r;
			float Smoothness76 = ( 1.0 - ( RoghnessValue84 * _Roughness ) );
			o.Smoothness = Smoothness76;
			o.Alpha = 1;
			float AlphaMap245 = tex2D( _AlphaMap, MainUVFinal262 ).r;
...
/*ASEBEGIN
Version=19603
Node;AmplifyShaderEditor.CommentaryNode;229;-2880,160;Inherit;False;2584.449;3538.463;Base Textures;61;255;254;253;252;251;250;249;242;235;231;195;245;64;243;241;244;238;14;236;15;237;88;63;12;228;84;10;227;31;9;11;226;56;32;83;82;5;53;52;28;18;4;55;29;16;248;257;258;259;260;261;262;264;266;267;268;269;270;271;273;274;;1,1,1,1;0;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;260;-2000,416;Inherit;False;0;4;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RegisterLocalVarNode;261;-1776,416;Inherit;False;MainUV;-1;True;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.GetLocalVarNode;259;-2112,544;Inherit;False;261;MainUV;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode;273;-1936,544;Inherit;False;UVHandling;0;;252;c17d079c1ac3cf440936a2325286a38a;0;1;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;262;-1760,544;Inherit;False;MainUVFinal;-1;True;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TexturePropertyNode;16;-2016,1344;Inherit;True;Property;_MetallicMap;Metallic Map;21;0;Create;False;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.TexturePropertyNode;29;-2016,1584;Inherit;True;Property;_SpecularMap;Specular Map;23;0;Create;False;0;0;0;False;0;False;None;95bc897e80af50446bc05c7e8d2649ae;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.GetLocalVarNode;266;-1760,1376;Inherit;False;262;MainUVFinal;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.GetLocalVarNode;267;-1744,1648;Inherit;False;262;MainUVFinal;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.GetLocalVarNode;269;-1744,2080;Inherit;False;262;MainUVFinal;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.GetLocalVarNode;270;-1760,2528;Inherit;False;262;MainUVFinal;1;0;OBJECT;;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.ColorNode;52;-1488,2224;Inherit;False;Property;_EmissionColor;Emission Color;14;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;4,4,4,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;250;-1504,2688;Inherit;False;Property;_EmissionColor2;Emission Color2;15;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;4,4,4,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.TexturePropertyNode;32;-2032,1808;Inherit;True;Property;_RoughnessMap;Roghness Map;25;0;Create;False;0;0;0;False;0;False;None;9ef4e7141633e7448abdfe031993c9c8;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;226;-1232,2128;Inherit;False;Property;_Emission;Emission;106;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;252;-1248,2592;Inherit;False;Property;_Emission2;Emission2;108;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;268;-1760,1856;Inherit;False;262;MainUVFinal;1;0;OBJECT;;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;228;-928,2016;Inherit;False;Property;_EnableEmission;EnableEmission;104;0;Create;True;0;0;0;False;0;False;0;True;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ToggleSwitchNode;254;-944,2480;Inherit;False;Property;_EnableEmission2;EnableEmission2;105;0;Create;True;0;0;0;False;0;False;0;True;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;272;-96,2384;Inherit;False;262;MainUVFinal;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TexturePropertyNode;12;-2032,656;Inherit;True;Property;_BumpMap;NormalMap;16;0;Create;False;0;0;0;False;0;False;None;aef25913bc0271f498e5006238d33577;True;bump;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.TexturePropertyNode;237;-2032,912;Inherit;True;Property;_DetailNormalMap;Detail Normal Map;17;0;Create;False;0;0;0;False;0;False;None;aef25913bc0271f498e5006238d33577;True;bump;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RangedFloatNode;15;-1808,768;Inherit;False;Property;_BumpScale;Normal Scale;20;0;Create;False;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;236;-1808,1024;Inherit;False;Property;_DetailNormalMapScale;Detail Normal Map Scale;18;0;Create;False;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;264;-1760,688;Inherit;False;262;MainUVFinal;1;0;OBJECT;;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;244;-2016,3392;Inherit;True;Property;_AlphaMap;AlphaMap;11;0;Create;False;0;0;0;False;0;False;None;c48f49805bc6dcb448988519f2f10bcc;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.GetLocalVarNode;271;-1760,3440;Inherit;False;262;MainUVFinal;1;0;OBJECT;;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;247;112,2384;Inherit;False;QuatumGlow;29;;254;7730a8711ab108044bac907ea573069c;0;1;286;FLOAT2;0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SamplerNode;243;-1504,3392;Inherit;True;Property;_TextureSample9;Texture Sample 2;5;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;245;-928,3440;Inherit;False;AlphaMap;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;195;-2464,256;Inherit;False;Property;_ShowMain;ShowMain;107;0;Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;231;-2464,352;Inherit;False;Property;_ShowRendering;ShowRendering;109;0;Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;235;-2640,352;Inherit;False;Property;_Culling;Culling;24;1;[Enum];Create;False;0;1;Option1;0;1;UnityEngine.Rendering.CullMode;True;0;False;2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;242;-2784,256;Inherit;False;Property;_Cutoff;Cutoff;19;0;Create;True;0;0;0;False;0;False;0.5;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;257;-2672,560;Inherit;False;Property;_ShaderType;ShaderType;103;0;Create;True;0;0;0;True;0;False;3;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;258;-2672,464;Inherit;False;Property;_RenderType;RenderType;102;0;Create;True;0;0;0;True;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;274;-2447.102,466.5776;Inherit;False;Property;_ShowParallax;ShowParallax;110;0;Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=A00F6FCB8FD799DE4C741F874B95FECACA93EEE9