...
Shader "Saphi/QuantumShaderMetallicCutout"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full_custom v, out Input o )
		{
			...
			int temp_output_18_0_g632 = _UVDiscardIndex;
			float2 lerpResult22_g632 = lerp( uv_MainTex , uv2_MainTex , (float)saturate( temp_output_18_0_g632 ));
			float2 uv3_MainTex = v.texcoord2.xy * _MainTex_ST.xy + _MainTex_ST.zw;
			int temp_output_26_0_g632 = ( temp_output_18_0_g632 - 1 );
			float2 lerpResult25_g632 = lerp( lerpResult22_g632 , uv3_MainTex , (float)saturate( temp_output_26_0_g632 ));
			float2 uv4_MainTex = v.texcoord3.xy * _MainTex_ST.xy + _MainTex_ST.zw;
			int temp_output_31_0_g632 = ( temp_output_26_0_g632 - 1 );
			float2 lerpResult29_g632 = lerp( lerpResult25_g632 , uv4_MainTex , (float)saturate( temp_output_31_0_g632 ));
			float2 uv5_MainTex = v.ase_texcoord4 * _MainTex_ST.xy + _MainTex_ST.zw;
			float2 lerpResult35_g632 = lerp( lerpResult29_g632 , uv5_MainTex.xy , (float)saturate( ( temp_output_31_0_g632 - 1 ) ));
			float2 UV16_g634 = lerpResult35_g632;
			float2 break3_g645 = UV16_g634;
			float2 temp_output_1_0_g645 = float2( 0,3 );
			float2 break4_g645 = temp_output_1_0_g645;
			float ifLocalVar15_g645 = 0;
			if( break3_g645.x >= break4_g645.x )
				ifLocalVar15_g645 = 1.0;
			float2 break7_g645 = ( temp_output_1_0_g645 + float2( 1,1 ) );
			float ifLocalVar20_g645 = 0;
			if( break3_g645.x <= break7_g645.x )
				ifLocalVar20_g645 = 1.0;
			float ifLocalVar22_g645 = 0;
			if( break3_g645.y >= break4_g645.y )
				ifLocalVar22_g645 = 1.0;
			float ifLocalVar23_g645 = 0;
			if( break3_g645.y <= break7_g645.y )
				ifLocalVar23_g645 = 1.0;
			float2 break3_g646 = UV16_g634;
			float2 temp_output_1_0_g646 = float2( 1,3 );
			float2 break4_g646 = temp_output_1_0_g646;
			float ifLocalVar15_g646 = 0;
			if( break3_g646.x >= break4_g646.x )
				ifLocalVar15_g646 = 1.0;
			float2 break7_g646 = ( temp_output_1_0_g646 + float2( 1,1 ) );
			float ifLocalVar20_g646 = 0;
			if( break3_g646.x <= break7_g646.x )
				ifLocalVar20_g646 = 1.0;
			float ifLocalVar22_g646 = 0;
			if( break3_g646.y >= break4_g646.y )
				ifLocalVar22_g646 = 1.0;
			float ifLocalVar23_g646 = 0;
			if( break3_g646.y <= break7_g646.y )
				ifLocalVar23_g646 = 1.0;
			float2 break3_g648 = UV16_g634;
			float2 temp_output_1_0_g648 = float2( 2,3 );
			float2 break4_g648 = temp_output_1_0_g648;
			float ifLocalVar15_g648 = 0;
			if( break3_g648.x >= break4_g648.x )
				ifLocalVar15_g648 = 1.0;
			float2 break7_g648 = ( temp_output_1_0_g648 + float2( 1,1 ) );
			float ifLocalVar20_g648 = 0;
			if( break3_g648.x <= break7_g648.x )
				ifLocalVar20_g648 = 1.0;
			float ifLocalVar22_g648 = 0;
			if( break3_g648.y >= break4_g648.y )
				ifLocalVar22_g648 = 1.0;
			float ifLocalVar23_g648 = 0;
			if( break3_g648.y <= break7_g648.y )
				ifLocalVar23_g648 = 1.0;
			float2 break3_g647 = UV16_g634;
			float2 temp_output_1_0_g647 = float2( 3,3 );
			float2 break4_g647 = temp_output_1_0_g647;
			float ifLocalVar15_g647 = 0;
			if( break3_g647.x >= break4_g647.x )
				ifLocalVar15_g647 = 1.0;
			float2 break7_g647 = ( temp_output_1_0_g647 + float2( 1,1 ) );
			float ifLocalVar20_g647 = 0;
			if( break3_g647.x <= break7_g647.x )
				ifLocalVar20_g647 = 1.0;
			float ifLocalVar22_g647 = 0;
			if( break3_g647.y >= break4_g647.y )
				ifLocalVar22_g647 = 1.0;
			float ifLocalVar23_g647 = 0;
			if( break3_g647.y <= break7_g647.y )
				ifLocalVar23_g647 = 1.0;
			float2 break3_g637 = UV16_g634;
			float2 temp_output_1_0_g637 = float2( 0,2 );
			float2 break4_g637 = temp_output_1_0_g637;
			float ifLocalVar15_g637 = 0;
			if( break3_g637.x >= break4_g637.x )
				ifLocalVar15_g637 = 1.0;
			float2 break7_g637 = ( temp_output_1_0_g637 + float2( 1,1 ) );
			float ifLocalVar20_g637 = 0;
			if( break3_g637.x <= break7_g637.x )
				ifLocalVar20_g637 = 1.0;
			float ifLocalVar22_g637 = 0;
			if( break3_g637.y >= break4_g637.y )
				ifLocalVar22_g637 = 1.0;
			float ifLocalVar23_g637 = 0;
			if( break3_g637.y <= break7_g637.y )
				ifLocalVar23_g637 = 1.0;
			float2 break3_g635 = UV16_g634;
			float2 temp_output_1_0_g635 = float2( 1,2 );
			float2 break4_g635 = temp_output_1_0_g635;
			float ifLocalVar15_g635 = 0;
			if( break3_g635.x >= break4_g635.x )
				ifLocalVar15_g635 = 1.0;
			float2 break7_g635 = ( temp_output_1_0_g635 + float2( 1,1 ) );
			float ifLocalVar20_g635 = 0;
			if( break3_g635.x <= break7_g635.x )
				ifLocalVar20_g635 = 1.0;
			float ifLocalVar22_g635 = 0;
			if( break3_g635.y >= break4_g635.y )
				ifLocalVar22_g635 = 1.0;
			float ifLocalVar23_g635 = 0;
			if( break3_g635.y <= break7_g635.y )
				ifLocalVar23_g635 = 1.0;
			float2 break3_g636 = UV16_g634;
			float2 temp_output_1_0_g636 = float2( 2,2 );
			float2 break4_g636 = temp_output_1_0_g636;
			float ifLocalVar15_g636 = 0;
			if( break3_g636.x >= break4_g636.x )
				ifLocalVar15_g636 = 1.0;
			float2 break7_g636 = ( temp_output_1_0_g636 + float2( 1,1 ) );
			float ifLocalVar20_g636 = 0;
			if( break3_g636.x <= break7_g636.x )
				ifLocalVar20_g636 = 1.0;
			float ifLocalVar22_g636 = 0;
			if( break3_g636.y >= break4_g636.y )
				ifLocalVar22_g636 = 1.0;
			float ifLocalVar23_g636 = 0;
			if( break3_g636.y <= break7_g636.y )
				ifLocalVar23_g636 = 1.0;
			float2 break3_g649 = UV16_g634;
			float2 temp_output_1_0_g649 = float2( 3,2 );
			float2 break4_g649 = temp_output_1_0_g649;
			float ifLocalVar15_g649 = 0;
			if( break3_g649.x >= break4_g649.x )
				ifLocalVar15_g649 = 1.0;
			float2 break7_g649 = ( temp_output_1_0_g649 + float2( 1,1 ) );
			float ifLocalVar20_g649 = 0;
			if( break3_g649.x <= break7_g649.x )
				ifLocalVar20_g649 = 1.0;
			float ifLocalVar22_g649 = 0;
			if( break3_g649.y >= break4_g649.y )
				ifLocalVar22_g649 = 1.0;
			float ifLocalVar23_g649 = 0;
			if( break3_g649.y <= break7_g649.y )
				ifLocalVar23_g649 = 1.0;
			float2 break3_g642 = UV16_g634;
			float2 temp_output_1_0_g642 = float2( 0,1 );
			float2 break4_g642 = temp_output_1_0_g642;
			float ifLocalVar15_g642 = 0;
			if( break3_g642.x >= break4_g642.x )
				ifLocalVar15_g642 = 1.0;
			float2 break7_g642 = ( temp_output_1_0_g642 + float2( 1,1 ) );
			float ifLocalVar20_g642 = 0;
			if( break3_g642.x <= break7_g642.x )
				ifLocalVar20_g642 = 1.0;
			float ifLocalVar22_g642 = 0;
			if( break3_g642.y >= break4_g642.y )
				ifLocalVar22_g642 = 1.0;
			float ifLocalVar23_g642 = 0;
			if( break3_g642.y <= break7_g642.y )
				ifLocalVar23_g642 = 1.0;
			float2 break3_g643 = UV16_g634;
			float2 temp_output_1_0_g643 = float2( 1,1 );
			float2 break4_g643 = temp_output_1_0_g643;
			float ifLocalVar15_g643 = 0;
			if( break3_g643.x >= break4_g643.x )
				ifLocalVar15_g643 = 1.0;
			float2 break7_g643 = ( temp_output_1_0_g643 + float2( 1,1 ) );
			float ifLocalVar20_g643 = 0;
			if( break3_g643.x <= break7_g643.x )
				ifLocalVar20_g643 = 1.0;
			float ifLocalVar22_g643 = 0;
			if( break3_g643.y >= break4_g643.y )
				ifLocalVar22_g643 = 1.0;
			float ifLocalVar23_g643 = 0;
			if( break3_g643.y <= break7_g643.y )
				ifLocalVar23_g643 = 1.0;
			float2 break3_g644 = UV16_g634;
			float2 temp_output_1_0_g644 = float2( 2,1 );
			float2 break4_g644 = temp_output_1_0_g644;
			float ifLocalVar15_g644 = 0;
			if( break3_g644.x >= break4_g644.x )
				ifLocalVar15_g644 = 1.0;
			float2 break7_g644 = ( temp_output_1_0_g644 + float2( 1,1 ) );
			float ifLocalVar20_g644 = 0;
			if( break3_g644.x <= break7_g644.x )
				ifLocalVar20_g644 = 1.0;
			float ifLocalVar22_g644 = 0;
			if( break3_g644.y >= break4_g644.y )
				ifLocalVar22_g644 = 1.0;
			float ifLocalVar23_g644 = 0;
			if( break3_g644.y <= break7_g644.y )
				ifLocalVar23_g644 = 1.0;
			float2 break3_g650 = UV16_g634;
			float2 temp_output_1_0_g650 = float2( 3,1 );
			float2 break4_g650 = temp_output_1_0_g650;
			float ifLocalVar15_g650 = 0;
			if( break3_g650.x >= break4_g650.x )
				ifLocalVar15_g650 = 1.0;
			float2 break7_g650 = ( temp_output_1_0_g650 + float2( 1,1 ) );
			float ifLocalVar20_g650 = 0;
			if( break3_g650.x <= break7_g650.x )
				ifLocalVar20_g650 = 1.0;
			float ifLocalVar22_g650 = 0;
			if( break3_g650.y >= break4_g650.y )
				ifLocalVar22_g650 = 1.0;
			float ifLocalVar23_g650 = 0;
			if( break3_g650.y <= break7_g650.y )
				ifLocalVar23_g650 = 1.0;
			float2 break3_g638 = UV16_g634;
			float2 temp_output_1_0_g638 = float2( 0,0 );
			float2 break4_g638 = temp_output_1_0_g638;
			float ifLocalVar15_g638 = 0;
			if( break3_g638.x >= break4_g638.x )
				ifLocalVar15_g638 = 1.0;
			float2 break7_g638 = ( temp_output_1_0_g638 + float2( 1,1 ) );
			float ifLocalVar20_g638 = 0;
			if( break3_g638.x <= break7_g638.x )
				ifLocalVar20_g638 = 1.0;
			float ifLocalVar22_g638 = 0;
			if( break3_g638.y >= break4_g638.y )
				ifLocalVar22_g638 = 1.0;
			float ifLocalVar23_g638 = 0;
			if( break3_g638.y <= break7_g638.y )
				ifLocalVar23_g638 = 1.0;
			float2 break3_g639 = UV16_g634;
			float2 temp_output_1_0_g639 = float2( 1,0 );
			float2 break4_g639 = temp_output_1_0_g639;
			float ifLocalVar15_g639 = 0;
			if( break3_g639.x >= break4_g639.x )
				ifLocalVar15_g639 = 1.0;
			float2 break7_g639 = ( temp_output_1_0_g639 + float2( 1,1 ) );
			float ifLocalVar20_g639 = 0;
			if( break3_g639.x <= break7_g639.x )
				ifLocalVar20_g639 = 1.0;
			float ifLocalVar22_g639 = 0;
			if( break3_g639.y >= break4_g639.y )
				ifLocalVar22_g639 = 1.0;
			float ifLocalVar23_g639 = 0;
			if( break3_g639.y <= break7_g639.y )
				ifLocalVar23_g639 = 1.0;
			float2 break3_g640 = UV16_g634;
			float2 temp_output_1_0_g640 = float2( 2,0 );
			float2 break4_g640 = temp_output_1_0_g640;
			float ifLocalVar15_g640 = 0;
			if( break3_g640.x >= break4_g640.x )
				ifLocalVar15_g640 = 1.0;
			float2 break7_g640 = ( temp_output_1_0_g640 + float2( 1,1 ) );
			float ifLocalVar20_g640 = 0;
			if( break3_g640.x <= break7_g640.x )
				ifLocalVar20_g640 = 1.0;
			float ifLocalVar22_g640 = 0;
			if( break3_g640.y >= break4_g640.y )
				ifLocalVar22_g640 = 1.0;
			float ifLocalVar23_g640 = 0;
			if( break3_g640.y <= break7_g640.y )
				ifLocalVar23_g640 = 1.0;
			float2 break3_g641 = UV16_g634;
			float2 temp_output_1_0_g641 = float2( 3,0 );
			float2 break4_g641 = temp_output_1_0_g641;
			float ifLocalVar15_g641 = 0;
			if( break3_g641.x >= break4_g641.x )
				ifLocalVar15_g641 = 1.0;
			float2 break7_g641 = ( temp_output_1_0_g641 + float2( 1,1 ) );
			float ifLocalVar20_g641 = 0;
			if( break3_g641.x <= break7_g641.x )
				ifLocalVar20_g641 = 1.0;
			float ifLocalVar22_g641 = 0;
			if( break3_g641.y >= break4_g641.y )
				ifLocalVar22_g641 = 1.0;
			float ifLocalVar23_g641 = 0;
			if( break3_g641.y <= break7_g641.y )
				ifLocalVar23_g641 = 1.0;
			float3 temp_cast_4 = (asfloat( -1 )).xxx;
			float3 Vertex151_g634 = float3( 0,0,0 );
			float3 ifLocalVar112_g634 = 0;
			if( ( ( ( ifLocalVar15_g645 * ifLocalVar20_g645 * ifLocalVar22_g645 * ifLocalVar23_g645 * _uvTileDiscard_0_3 ) + ( ifLocalVar15_g646 * ifLocalVar20_g646 * ifLocalVar22_g646 * ifLocalVar23_g646 * _uvTileDiscard_1_3 ) + ( ifLocalVar15_g648 * ifLocalVar20_g648 * ifLocalVar22_g648 * ifLocalVar23_g648 * _uvTileDiscard_2_3 ) + ( ifLocalVar15_g647 * ifLocalVar20_g647 * ifLocalVar22_g647 * ifLocalVar23_g647 * _uvTileDiscard_3_3 ) ) + ( ( ifLocalVar15_g637 * ifLocalVar20_g637 * ifLocalVar22_g637 * ifLocalVar23_g637 * _uvTileDiscard_0_2 ) + ( ifLocalVar15_g635 * ifLocalVar20_g635 * ifLocalVar22_g635 * ifLocalVar23_g635 * _uvTileDiscard_1_2 ) + ( ifLocalVar15_g636 * ifLocalVar20_g636 * ifLocalVar22_g636 * ifLocalVar23_g636 * _uvTileDiscard_2_2 ) + ( ifLocalVar15_g649 * ifLocalVar20_g649 * ifLocalVar22_g649 * ifLocalVar23_g649 * _uvTileDiscard_3_2 ) ) + ( ( ifLocalVar15_g642 * ifLocalVar20_g642 * ifLocalVar22_g642 * ifLocalVar23_g642 * _uvTileDiscard_0_1 ) + ( ifLocalVar15_g643 * ifLocalVar20_g643 * ifLocalVar22_g643 * ifLocalVar23_g643 * _uvTileDiscard_1_1 ) + ( ifLocalVar15_g644 * ifLocalVar20_g644 * ifLocalVar22_g644 * ifLocalVar23_g644 * _uvTileDiscard_2_1 ) + ( ifLocalVar15_g650 * ifLocalVar20_g650 * ifLocalVar22_g650 * ifLocalVar23_g650 * _uvTileDiscard_3_1 ) ) + ( ( ifLocalVar15_g638 * ifLocalVar20_g638 * ifLocalVar22_g638 * ifLocalVar23_g638 * _uvTileDiscard_0_0 ) + ( ifLocalVar15_g639 * ifLocalVar20_g639 * ifLocalVar22_g639 * ifLocalVar23_g639 * _uvTileDiscard_1_0 ) + ( ifLocalVar15_g640 * ifLocalVar20_g640 * ifLocalVar22_g640 * ifLocalVar23_g640 * _uvTileDiscard_2_0 ) + ( ifLocalVar15_g641 * ifLocalVar20_g641 * ifLocalVar22_g641 * ifLocalVar23_g641 * _uvTileDiscard_3_0 ) ) ) <= 0.5 )
				ifLocalVar112_g634 = Vertex151_g634;
			else
				ifLocalVar112_g634 = temp_cast_4;
			float3 VertexOffset274 = ifLocalVar112_g634;
			v.vertex.xyz += VertexOffset274;
			v.vertex.w = 1;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 temp_output_9_0_g633 = BlendNormals( UnpackScaleNormal( tex2D( _BumpMap, MainUVFinal230 ), _BumpScale ) , UnpackScaleNormal( tex2D( _DetailNormalMap, lerpResult35_g326 ), _DetailNormalMapScale ) );
			float _switch4_g633 = _BackFaceNormalMode;
			float3 flip4_g633 = float3( -1, -1, -1 );
			float3 mirror4_g633 = float3( 1, 1, -1 );
			float3 none4_g633 = float3( 1, 1, 1 );
			float3 localBackFaceNormalMode4_g633 = BackFaceNormalMode( _switch4_g633 , flip4_g633 , mirror4_g633 , none4_g633 );
			float3 switchResult2_g633 = (((i.ASEIsFrontFace>0)?(temp_output_9_0_g633):(( temp_output_9_0_g633 * localBackFaceNormalMode4_g633 ))));
			#ifdef _BACKFACENORMAL_ON
				float3 staticSwitch11_g633 = switchResult2_g633;
			#else
				float3 staticSwitch11_g633 = temp_output_9_0_g633;
			#endif
			float3 Normal64 = staticSwitch11_g633;
			o.Normal = Normal64;
...
/*ASEBEGIN
Version=19908
Node;AmplifyShaderEditor.CommentaryNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;203;-3620.697,158;Inherit;False;3715.945;3059.038;Base Textures;69;239;227;226;210;205;195;204;64;212;63;271;213;10;209;252;214;11;9;208;14;251;248;4;206;231;15;12;250;207;224;88;230;249;262;83;223;202;238;257;256;222;201;232;259;258;255;221;220;200;56;28;229;260;261;219;218;53;52;233;29;247;254;253;235;234;217;55;246;272;;1,1,1,1;0;0
Node;AmplifyShaderEditor.IntNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;246;-1776,448;Inherit;False;Property;_MainUVIndex;MainUVIndex;135;1;[Enum];Create;True;0;5;UV0;0;UV1;1;UV2;2;UV3;3;UV4;4;0;False;0;False;0;0;False;0;0;0;1;INT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;29;-1760,1264;Inherit;True;Property;_MetallicGlossMap;Metallic Gloss Map;48;0;Create;False;0;0;0;False;0;False;None;95bc897e80af50446bc05c7e8d2649ae;False;black;Auto;Texture2D;False;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.ColorNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;52;-1232,1760;Inherit;False;Property;_EmissionColor;Emission Color;43;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;4,4,4,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;219;-1232,2208;Inherit;False;Property;_EmissionColor2;Emission Color2;42;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;4,4,4,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;200;-864,1664;Inherit;False;Property;_Emission;Emission;133;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;221;-976,2112;Inherit;False;Property;_Emission2;Emission2;138;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;255;-960,1328;Inherit;False;Property;_Metallic;Metallic;127;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;258;-1200,2976;Inherit;False;Property;_Glossiness;Glossiness;125;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ToggleSwitchNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;259;-1136,2880;Inherit;False;Property;_AlbedoAlpha;AlbedoAlpha;126;0;Create;True;0;0;0;False;0;False;0;True;Create;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;238;-1664,560;Inherit;False;UVHandling;28;;290;c17d079c1ac3cf440936a2325286a38a;0;1;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.ToggleSwitchNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;202;-560,1552;Inherit;False;Property;_EnableEmission;EnableEmission;132;0;Create;True;0;0;0;False;0;False;0;True;Create;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ToggleSwitchNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;223;-672,2000;Inherit;False;Property;_EnableEmission2;EnableEmission2;137;0;Create;True;0;0;0;False;0;False;0;True;Create;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.IntNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;249;-1920,1088;Inherit;False;Property;_DetailUVIndex;DetailUVIndex;140;1;[Enum];Create;True;0;5;UV0;0;UV1;1;UV2;2;UV3;3;UV4;4;0;False;0;False;0;0;False;0;0;0;1;INT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;207;-1968,880;Inherit;True;Property;_DetailNormalMap;Detail Normal Map;46;0;Create;False;0;0;0;False;0;False;None;aef25913bc0271f498e5006238d33577;True;bump;Auto;Texture2D;False;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TexturePropertyNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;12;-1760,656;Inherit;True;Property;_BumpMap;NormalMap;44;0;Create;False;0;0;0;False;0;False;None;aef25913bc0271f498e5006238d33577;True;bump;Auto;Texture2D;False;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;15;-1536,768;Inherit;False;Property;_BumpScale;Normal Scale;45;0;Create;False;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;206;-1680,1072;Inherit;False;Property;_DetailNormalMapScale;Detail Normal Map Scale;49;0;Create;False;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.IntNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;251;-1824,2704;Inherit;False;Property;_AlphaUVIndex;AlphaUVIndex;134;1;[Enum];Create;True;0;5;UV0;0;UV1;1;UV2;2;UV3;3;UV4;4;0;False;0;False;0;0;False;0;0;0;1;INT;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;216;480,2192;Inherit;False;QuatumGlow;50;;366;7730a8711ab108044bac907ea573069c;0;0;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;267;560,2304;Inherit;False;LightVolumesMetallicConnector;20;;424;4103f3421d11ef3498c02a836aaf4678;0;5;32;FLOAT3;0,0,0;False;30;FLOAT;0;False;31;FLOAT;0;False;1;FLOAT3;0,0,0;False;90;FLOAT;1;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.TexturePropertyNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;4;-2544,208;Inherit;True;Property;_MainTex;Main Tex;37;0;Create;True;0;0;0;False;0;False;None;a16b3161c8c05f54ba87ec06bfdd6b82;False;white;Auto;Texture2D;False;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.IntNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;272;-2528,448;Inherit;False;Property;_UVDiscardIndex;UVDiscardIndex;142;1;[Enum];Create;True;0;5;UV0;0;UV1;1;UV2;2;UV3;3;UV4;4;0;False;0;False;0;0;False;0;0;0;1;INT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;214;-1840,2496;Inherit;True;Property;_AlphaMap;AlphaMap;41;0;Create;True;0;0;0;False;0;False;None;c48f49805bc6dcb448988519f2f10bcc;False;white;Auto;Texture2D;False;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.StaticSwitch, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;264;880,2288;Inherit;False;Property;_Q_LightVolumes;Q_LightVolumes;141;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;275;-2304,432;Inherit;False;UVSelect;-1;;632;be9f0a2bbb8e0f340a2211011430e00a;0;2;3;SAMPLER2D;1,1;False;18;INT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;271;-608,656;Inherit;False;NormalMode;17;;633;6f5fb00256a34c94fb3861e426d1fe24;0;1;9;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;273;-2112,432;Inherit;False;UVTileDiscard;0;;634;e9e21a74b1cdc514ba440ff7dcde62f0;0;2;150;FLOAT3;0,0,0;False;15;FLOAT2;0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.CommentaryNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;211;494,158;Inherit;False;1717.043;670.9683;Output;8;0;215;81;74;65;75;263;276;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;274;-2112,528;Inherit;False;VertexOffset;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;204;-3184,336;Inherit;False;Property;_ShowRendering;ShowRendering;136;0;Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;195;-3184,256;Inherit;False;Property;_ShowMain;ShowMain;131;0;Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;205;-3376,336;Inherit;False;Property;_Culling;Culling;130;1;[Enum];Create;False;0;1;Option1;0;1;UnityEngine.Rendering.CullMode;True;0;False;2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;210;-3472,256;Inherit;False;Property;_Cutoff;Cutoff;47;0;Create;True;0;0;0;False;0;False;0.5;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;226;-3376,528;Inherit;False;Property;_ShaderType;ShaderType;128;0;Create;True;0;0;0;True;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;227;-3376,432;Inherit;False;Property;_RenderType;RenderType;129;0;Create;True;0;0;0;True;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;239;-3168,432;Inherit;False;Property;_ShowParallax;ShowParallax;139;0;Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;215;1152,624;Inherit;False;212;AlphaMap;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;276;1456,704;Inherit;False;274;VertexOffset;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;278;-3176.981,529.2755;Inherit;False;Property;_ShowUVTileDiscard;ShowUVTileDiscard;143;0;Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;0;1808,240;Float;False;True;-1;4;Saphi.QuantumShader.QuantumShaderUI;0;0;Standard;Saphi/QuantumShaderMetallicCutout;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;;0;False;;False;0;False;;0;False;;False;0;0;False;;0;Masked;0.5;True;True;0;False;TransparentCutout;;AlphaTest;All;12;all;True;True;True;True;0;False;;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;2;15;10;25;False;0.5;True;0;0;False;;0;False;;0;0;False;;0;False;;0;False;;0;False;;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;-1;-1;-1;-1;0;False;0;0;True;_Culling;-1;0;True;_Cutoff;1;Include;;True;1ec20832dfbb48343b8e0764e0864276;Custom;False;0;0;;0;0;False;0.1;False;;0;False;;False;17;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;16;FLOAT4;0,0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;275;3;4;0
WireConnection;275;18;272;0
...
WireConnection;0;11;276;0
ASEEND*/
//CHKSM=BB46CD146210E53C519B4AA039DE2F2F2173A1A1