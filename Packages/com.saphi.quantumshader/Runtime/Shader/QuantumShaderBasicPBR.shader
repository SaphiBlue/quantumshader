...
Shader "Saphi/QuantumShaderBasicPBR"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float3 temp_output_9_0_g513 = BlendNormals( UnpackScaleNormal( tex2D( _BumpMap, MainUVFinal259 ), _BumpScale ) , UnpackScaleNormal( tex2D( _DetailNormalMap, lerpResult35_g326 ), _DetailNormalMapScale ) );
			...
			LightVolumeSH( worldPos1_g400 , L01_g400 , L1r1_g400 , L1g1_g400 , L1b1_g400 , worldPosOffset1_g400 );
				...
				float3 staticSwitch129_g399 = ( staticSwitch17_g399 - appendResult13_g399 );
			#else
				float3 staticSwitch129_g399 = staticSwitch17_g399;
			#endif
			#ifdef _LIGHTVOLUMES_ON
				float3 staticSwitch21_g399 = staticSwitch129_g399;
			#else
				float3 staticSwitch21_g399 = appendResult13_g399;
			#endif
			float3 L025_g399 = staticSwitch21_g399;
			float3 L02_g404 = L025_g399;
			float3 temp_output_10_0_g399 = (unity_SHAr).xyz;
			#ifdef LIGHTMAP_ON
			...
			#endif
			#ifdef _LIGHTVOLUMESSUBSTRACTLIGHTPROBES_ON
				float3 staticSwitch128_g399 = ( staticSwitch14_g399 - temp_output_10_0_g399 );
			#else
				float3 staticSwitch128_g399 = staticSwitch14_g399;
			#endif
			#ifdef _LIGHTVOLUMES_ON
				float3 staticSwitch18_g399 = staticSwitch128_g399;
			#else
				float3 staticSwitch18_g399 = temp_output_10_0_g399;
			#endif
			float3 L1r22_g399 = staticSwitch18_g399;
			float3 L1r2_g404 = L1r22_g399;
			float3 temp_output_11_0_g399 = (unity_SHAg).xyz;
			#ifdef LIGHTMAP_ON
			...
			#endif
			#ifdef _LIGHTVOLUMESSUBSTRACTLIGHTPROBES_ON
				float3 staticSwitch123_g399 = ( staticSwitch15_g399 - temp_output_11_0_g399 );
			#else
				float3 staticSwitch123_g399 = staticSwitch15_g399;
			#endif
			#ifdef _LIGHTVOLUMES_ON
				float3 staticSwitch19_g399 = staticSwitch123_g399;
			#else
				float3 staticSwitch19_g399 = temp_output_11_0_g399;
			#endif
			float3 L1g23_g399 = staticSwitch19_g399;
			float3 L1g2_g404 = L1g23_g399;
			float3 temp_output_12_0_g399 = (unity_SHAb).xyz;
			#ifdef LIGHTMAP_ON
			...
			#endif
			#ifdef _LIGHTVOLUMESSUBSTRACTLIGHTPROBES_ON
				float3 staticSwitch122_g399 = ( staticSwitch16_g399 - temp_output_12_0_g399 );
			#else
				float3 staticSwitch122_g399 = staticSwitch16_g399;
			#endif
			#ifdef _LIGHTVOLUMES_ON
				float3 staticSwitch20_g399 = staticSwitch122_g399;
			#else
				float3 staticSwitch20_g399 = temp_output_12_0_g399;
			#endif
			float3 L1b24_g399 = staticSwitch20_g399;
			float3 L1b2_g404 = L1b24_g399;
			float3 localLightVolumeEvaluate2_g404 = LightVolumeEvaluate( worldNormal2_g404 , L02_g404 , L1r2_g404 , L1g2_g404 , L1b2_g404 );
			float3 Albedo33_g399 = SpecularAlbedo72;
			float3 temp_output_82_0_g399 = ( localLightVolumeEvaluate2_g404 * Albedo33_g399 );
			...
			float3 f0157_g403 = temp_output_138_0_g403;
			...
			float smoothness157_g403 = temp_output_3_0_g403;
			float3 temp_output_2_0_g403 = World_Normal53_g399;
			float3 worldNormal157_g403 = temp_output_2_0_g403;
			float3 ase_viewDirSafeWS = Unity_SafeNormalize( ase_viewVectorWS );
			float3 temp_output_9_0_g403 = ase_viewDirSafeWS;
			float3 viewDir157_g403 = temp_output_9_0_g403;
			float3 temp_output_65_0_g403 = L025_g399;
			float3 L0157_g403 = temp_output_65_0_g403;
			float3 temp_output_1_0_g403 = L1r22_g399;
			float3 L1r157_g403 = temp_output_1_0_g403;
			float3 temp_output_36_0_g403 = L1g23_g399;
			float3 L1g157_g403 = temp_output_36_0_g403;
			float3 temp_output_37_0_g403 = L1b24_g399;
			float3 L1b157_g403 = temp_output_37_0_g403;
			float3 localLightVolumeSpecular157_g403 = LightVolumeSpecular( f0157_g403 , smoothness157_g403 , worldNormal157_g403 , viewDir157_g403 , L0157_g403 , L1r157_g403 , L1g157_g403 , L1b157_g403 );
			float3 temp_output_138_0_g402 = SpecularMap34_g399;
			float3 f0158_g402 = temp_output_138_0_g402;
			float temp_output_3_0_g402 = Smoothness35_g399;
			float smoothness158_g402 = temp_output_3_0_g402;
			float3 temp_output_2_0_g402 = World_Normal53_g399;
			float3 worldNormal158_g402 = temp_output_2_0_g402;
			float3 temp_output_9_0_g402 = ase_viewDirSafeWS;
			float3 viewDir158_g402 = temp_output_9_0_g402;
			float3 temp_output_65_0_g402 = L025_g399;
			float3 L0158_g402 = temp_output_65_0_g402;
			float3 temp_output_1_0_g402 = L1r22_g399;
			float3 L1r158_g402 = temp_output_1_0_g402;
			float3 temp_output_36_0_g402 = L1g23_g399;
			float3 L1g158_g402 = temp_output_36_0_g402;
			float3 temp_output_37_0_g402 = L1b24_g399;
			float3 L1b158_g402 = temp_output_37_0_g402;
			float3 localLightVolumeSpecularDominant158_g402 = LightVolumeSpecularDominant( f0158_g402 , smoothness158_g402 , worldNormal158_g402 , viewDir158_g402 , L0158_g402 , L1r158_g402 , L1g158_g402 , L1b158_g402 );
			#ifdef _DOMINANTDIRSPECULARS_ON
				float3 staticSwitch38_g399 = localLightVolumeSpecularDominant158_g402;
			#else
				float3 staticSwitch38_g399 = localLightVolumeSpecular157_g403;
			#endif
			float AO56_g399 = 1.0;
...
Node;AmplifyShaderEditor.IntNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;274;-1920,448;Inherit;False;Property;_MainUVIndex;MainUVIndex;115;1;[Enum];Create;True;0;5;UV0;0;UV1;1;UV2;2;UV3;3;UV4;4;0;False;0;False;0;0;False;0;1;INT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;32;-1856,1808;Inherit;True;Property;_RoughnessMap;Roughness Map;34;0;Create;False;0;0;0;False;0;False;None;9ef4e7141633e7448abdfe031993c9c8;False;white;Auto;Texture2D;False;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TexturePropertyNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;55;-1856,2016;Inherit;True;Property;_EmissionMap;Emission Map;23;0;Create;True;0;0;0;False;0;False;None;c48f49805bc6dcb448988519f2f10bcc;False;white;Auto;Texture2D;False;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.TexturePropertyNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;246;-1840,2448;Inherit;True;Property;_EmissionMap2;Emission Map 2;22;0;Create;True;0;0;0;False;0;False;None;c48f49805bc6dcb448988519f2f10bcc;False;black;Auto;Texture2D;False;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;269;-1728,560;Inherit;False;UVHandling;3;;290;c17d079c1ac3cf440936a2325286a38a;0;1;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TexturePropertyNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;16;-1840,1344;Inherit;True;Property;_MetallicMap;Metallic Map;30;0;Create;False;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;False;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.ColorNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;52;-1312,2224;Inherit;False;Property;_EmissionColor;Emission Color;25;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;4,4,4,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;250;-1296,2656;Inherit;False;Property;_EmissionColor2;Emission Color2;24;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;4,4,4,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.TexturePropertyNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;4;-1952,208;Inherit;True;Property;_MainTex;Main Tex;20;0;Create;True;0;0;0;False;0;False;None;a16b3161c8c05f54ba87ec06bfdd6b82;False;white;Auto;Texture2D;False;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;226;-1056,2128;Inherit;False;Property;_Emission;Emission;120;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;245;-1040,2560;Inherit;False;Property;_Emission2;Emission2;121;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;11;-1280,416;Inherit;False;Property;_Color;Color;21;0;Create;False;0;0;0;False;0;False;0,0,0,0;1,1,1,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ToggleSwitchNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;228;-752,2016;Inherit;False;Property;_EnableEmission;EnableEmission;119;0;Create;True;0;0;0;False;0;False;0;True;Create;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ToggleSwitchNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;249;-736,2448;Inherit;False;Property;_EnableEmission2;EnableEmission2;118;0;Create;True;0;0;0;False;0;False;0;True;Create;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.IntNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;276;-2176,1104;Inherit;False;Property;_DetailUVIndex;DetailUVIndex;114;1;[Enum];Create;True;0;5;UV0;0;UV1;1;UV2;2;UV3;3;UV4;4;0;False;0;False;0;0;False;0;1;INT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;12;-1856,656;Inherit;True;Property;_BumpMap;NormalMap;26;0;Create;False;0;0;0;False;0;False;None;aef25913bc0271f498e5006238d33577;True;bump;Auto;Texture2D;False;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;15;-1632,768;Inherit;False;Property;_BumpScale;Normal Scale;29;0;Create;False;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;236;-1776,1104;Inherit;False;Property;_DetailNormalMapScale;Detail Normal Map Scale;28;0;Create;False;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;254;80,2384;Inherit;False;QuatumGlow;38;;363;7730a8711ab108044bac907ea573069c;0;0;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;277;208,2544;Inherit;False;LightVolumesSpecularConnector;12;;399;e7830579c7edaa2489fdbf704cb14f73;0;5;32;FLOAT3;0,0,0;False;30;FLOAT3;0,0,0;False;31;FLOAT;0;False;1;FLOAT3;0,0,0;False;90;FLOAT;1;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.StaticSwitch, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;283;528,2528;Inherit;False;Property;_Q_LightVolumes;Q_LightVolumes;113;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;284;-800,656;Inherit;False;NormalMode;0;;513;6f5fb00256a34c94fb3861e426d1fe24;0;1;9;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;235;-3712,384;Inherit;False;Property;_Culling;Culling;33;1;[Enum];Create;False;0;1;Option1;0;1;UnityEngine.Rendering.CullMode;True;0;False;2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;231;-3552,384;Inherit;False;Property;_ShowRendering;ShowRendering;123;0;Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;195;-3552,288;Inherit;False;Property;_ShowMain;ShowMain;122;0;Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;256;-3712,576;Inherit;False;Property;_ShaderType;ShaderType;117;0;Create;True;0;0;0;True;0;False;3;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;255;-3712,480;Inherit;False;Property;_RenderType;RenderType;116;0;Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;270;-3520,480;Inherit;False;Property;_ShowParallax;ShowParallax;124;0;Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=D1AF043B9FE96C5A5C39629493C9D318B1B35B96